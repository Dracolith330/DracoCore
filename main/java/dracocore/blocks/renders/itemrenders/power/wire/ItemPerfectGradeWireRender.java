...
public class ItemPerfectGradeWireRender implements IItemRenderer {

	private static final ResourceLocation ManaPipe = new ResourceLocation(References.texturelocation, "textures/model/PerfectGradeWire.png");
    public final IModelCustom Pipe;
    
	public ItemPerfectGradeWireRender() {
