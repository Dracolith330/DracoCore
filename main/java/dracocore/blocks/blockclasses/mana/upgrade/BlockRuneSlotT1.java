...
public class BlockRuneSlotT1 extends BaseRuneSlot
{
    ...
    {
    	TileEntityRunicUpgradeT1 tileEntity = (TileEntityRunicUpgradeT1) world.getTileEntity(x, y, z);
    ...
    {
        return new TileEntityRunicUpgradeT1();
    }
}