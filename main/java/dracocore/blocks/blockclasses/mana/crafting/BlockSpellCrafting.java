...
public class BlockSpellCrafting extends BlockContainer
{
    ...
    {
    	TileEntitySpellCrafting tileEntity = (TileEntitySpellCrafting) world.getTileEntity(x, y, z);
    	...
    	if (playerItem != null)
    	{
    		...
    		{
    			if(tileEntity.getStackInSlot(x1) == null)
    			{
    				ItemStack newItem = playerItem.copy();
        			newItem.stackSize = 1;
        			--playerItem.stackSize;
        			tileEntity.setInventorySlotContents(x1, newItem);
    	...
    	{
    		for(int x1 = 12; x1 > 0; x1--)
    		{
    			if(tileEntity.getStackInSlot(x1) != null)
    			{
    				player.inventory.addItemStackToInventory(tileEntity.getStackInSlot(x1));
    	...
    	{
    		if(playerItem.getItem() == Items.stick)
    		{
    ...
    {
        return new TileEntitySpellCrafting();
    }
