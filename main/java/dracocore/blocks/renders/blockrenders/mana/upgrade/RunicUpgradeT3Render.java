...
public class RunicUpgradeT3Render extends TileEntitySpecialRenderer {
    ...
    public void renderAModelAt(TileEntityRunicUpgradeT3 tileentity1, double d, double d1, double d2, float f) {
        ...
        if (tileentity1 instanceof TileEntityRunicUpgradeT3)
        {
        	TileEntityRunicUpgradeT3 tileAltar = (TileEntityRunicUpgradeT3) tileentity1;
        ...
        {
        	renderAModelAt((TileEntityRunicUpgradeT3)tileentity, d, d1, d2, f);
        }
