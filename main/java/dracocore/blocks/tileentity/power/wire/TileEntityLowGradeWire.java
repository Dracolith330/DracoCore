...
public class TileEntityLowGradeWire extends TileBaseUniversalElectricalSource implements IPacketReceiver, ISidedInventory, IConnector
{
    ...
    public TileEntityLowGradeWire()
    {
    	
    }
    
    public TileEntityLowGradeWire(int Capacity, int maxExtract)
    {
