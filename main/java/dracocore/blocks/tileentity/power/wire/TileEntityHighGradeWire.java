...
public class TileEntityHighGradeWire extends TileBaseUniversalElectricalSource implements IPacketReceiver, ISidedInventory, IConnector
{
    ...
    public TileEntityHighGradeWire()
    {
    	
    }
    
    public TileEntityHighGradeWire(int Capacity, int maxExtract)
    {
