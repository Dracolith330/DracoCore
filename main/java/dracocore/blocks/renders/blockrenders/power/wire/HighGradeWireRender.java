...
public class HighGradeWireRender extends TileEntitySpecialRenderer 
{
    private static final ResourceLocation Wire = new ResourceLocation(References.texturelocation, "textures/model/HighGradeWire.png");
    public final IModelCustom WireModel;

    public HighGradeWireRender() {
    ...
    public void renderModelAt(TileEntityHighGradeWire tileentity, double d, double d1, double d2, float f)
    {
    	// Texture file
    	FMLClientHandler.instance().getClient().renderEngine.bindTexture(HighGradeWireRender.Wire);
    	GL11.glPushMatrix();
    ...
    {
    	renderModelAt((TileEntityHighGradeWire)tileentity, d, d1, d2, f);
    }
 
    
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
    	
		TileEntityRendererDispatcher.instance.renderTileEntityAt(new TileEntityHighGradeWire(), 0.0D, 0.0D, 0.0D, 0.0F);
	}
