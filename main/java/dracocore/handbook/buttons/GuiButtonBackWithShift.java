...
public class GuiButtonBackWithShift extends GuiButtonBack {
    ...
    public List<String> getTooltip() {
        return Arrays.asList(StatCollector.translateToLocal("dracocoremisc.back"), EnumChatFormatting.GRAY + StatCollector.translateToLocal("dracocoremisc.clickToIndex"));
    }
