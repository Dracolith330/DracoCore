...
public class MediumGradeWireRender extends TileEntitySpecialRenderer 
{
    private static final ResourceLocation Wire = new ResourceLocation(References.texturelocation, "textures/model/MediumGradeWire.png");
    public final IModelCustom WireModel;

    public MediumGradeWireRender() {
    ...
    public void renderModelAt(TileEntityMediumGradeWire tileentity, double d, double d1, double d2, float f)
    {
    	// Texture file
    	FMLClientHandler.instance().getClient().renderEngine.bindTexture(MediumGradeWireRender.Wire);
    	GL11.glPushMatrix();
    ...
    {
    	renderModelAt((TileEntityMediumGradeWire)tileentity, d, d1, d2, f);
    }
 
    
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
    	
		TileEntityRendererDispatcher.instance.renderTileEntityAt(new TileEntityMediumGradeWire(), 0.0D, 0.0D, 0.0D, 0.0F);
	}
