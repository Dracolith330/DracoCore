...
import dracocore.handbook.interfaces.ITwoNamedPage;
...
public class BLexiconEntry extends LexiconEntry {
    ...
    public LexiconEntry setLexiconPages(LexiconPage... pages) {
        for (LexiconPage page : pages) {
            page.unlocalizedName = "dracocore.page." + getLazyUnlocalizedName() + page.unlocalizedName;
            if (page instanceof ITwoNamedPage) {
                ITwoNamedPage dou = (ITwoNamedPage) page;
                dou.setSecondUnlocalizedName("dracocore.page." + getLazyUnlocalizedName() + dou.getSecondUnlocalizedName());
            }
        }
    ...
    public String getUnlocalizedName() {
        return "dracocore.entry." + super.getUnlocalizedName();
    }
