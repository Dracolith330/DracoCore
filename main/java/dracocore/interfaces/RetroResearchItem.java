...
public class RetroResearchItem extends ResearchItem {
public ResearchItem original;
	public RetroResearchItem(String name, String cat, String origin, String originCategory, int x, int y, ResourceLocation icon) 
	{
	...
	public RetroResearchItem(String name, String cat, String origin, String originCategory, int x, int y, ItemStack icon) 
	{
		super(name, cat, new AspectList(), x, y, 1, icon);
		original = ((ResearchCategoryList) ResearchCategories.researchCategories.get(originCategory)).research.get(origin);
		bindToOriginal();
