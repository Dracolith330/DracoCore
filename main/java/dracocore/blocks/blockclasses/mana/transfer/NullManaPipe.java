...
public class NullManaPipe extends BlockTransmitter implements ITileEntityProvider, ItemBlockDesc.IBlockShiftDesc
{
    ...
    {
    	return new TileNullifiedManaPipe();
    }
    @Override
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int idk, float what, float these, float are)
    {
    	TileNullifiedManaPipe tileEntity = (TileNullifiedManaPipe) world.getTileEntity(x, y, z);
