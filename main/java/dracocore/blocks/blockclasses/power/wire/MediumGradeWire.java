...
public class MediumGradeWire extends BlockTransmitter implements ITileEntityProvider, ItemBlockDesc.IBlockShiftDesc
{
	
    public MediumGradeWire()
    {
    ...
    {
    	return new TileEntityMediumGradeWire(150, 150);
    }
    @Override
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int idk, float what, float these, float are)
    {
    	TileEntityMediumGradeWire tileEntity = (TileEntityMediumGradeWire) world.getTileEntity(x, y, z);
