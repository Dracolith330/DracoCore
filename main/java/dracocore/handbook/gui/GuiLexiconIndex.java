...
import dracocore.handbook.buttons.GuiButtonBack;
import dracocore.handbook.buttons.GuiButtonInvisible;
import dracocore.handbook.buttons.GuiButtonPage;
...
public class GuiLexiconIndex extends GuiLexicon implements IParented {
    ...
    public GuiLexiconIndex(LexiconCategory category) {
        ...
        title = StatCollector.translateToLocal(category == null ? "dracocoremisc.lexiconIndex" : category.getUnlocalizedName());
