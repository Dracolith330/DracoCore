...
public class LowGradeWireRender extends TileEntitySpecialRenderer 
{
    private static final ResourceLocation Wire = new ResourceLocation(References.texturelocation, "textures/model/LowGradeWire.png");
    public final IModelCustom WireModel;

    public LowGradeWireRender() {
    ...
    public void renderModelAt(TileEntityLowGradeWire tileentity, double d, double d1, double d2, float f)
    {
    	// Texture file
    	FMLClientHandler.instance().getClient().renderEngine.bindTexture(LowGradeWireRender.Wire);
    	GL11.glPushMatrix();
    ...
    {
    	renderModelAt((TileEntityLowGradeWire)tileentity, d, d1, d2, f);
    }
 
    
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
    	
		TileEntityRendererDispatcher.instance.renderTileEntityAt(new TileEntityLowGradeWire(), 0.0D, 0.0D, 0.0D, 0.0F);
	}
