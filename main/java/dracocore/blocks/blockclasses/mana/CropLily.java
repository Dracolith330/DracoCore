...
public class CropLily extends BlockTransmitter implements ITileEntityProvider, ItemBlockDesc.IBlockShiftDesc
{
    ...
    {
    	return new TileCropLily();
    }
    @Override
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int idk, float what, float these, float are)
    {
    	TileCropLily tileEntity = (TileCropLily) world.getTileEntity(x, y, z);
