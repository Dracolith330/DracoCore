...
public class LuxGenerator extends BlockTransmitter implements ITileEntityProvider, ItemBlockDesc.IBlockShiftDesc
{
    ...
    {
    	return new TileLuxGenerator();
    }
    @Override
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int idk, float what, float these, float are)
    {
    	TileLuxGenerator tileEntity = (TileLuxGenerator) world.getTileEntity(x, y, z);
