...
public class TileEntityCopperWireRender implements ISimpleBlockRenderingHandler
{
    final int renderID;

    public TileEntityCopperWireRender(int var1)
    {
        this.renderID = var1;
    }
    ...
    public void renderPipe(RenderBlocks renderblocks, IBlockAccess iblockaccess, Block block, int x, int y, int z)
    {
        ...
        if (tileEntity != null)
        {
            final TileEntity[] connections = PowerUtil.getAdjacentPowerConnections(tileEntity);
