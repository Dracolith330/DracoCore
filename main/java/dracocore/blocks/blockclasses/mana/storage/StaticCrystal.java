...
public class StaticCrystal extends BlockTileGC implements ItemBlockDesc.IBlockShiftDesc
{
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLiving, ItemStack itemStack)
    {
    	...
    	if (l == 0) {
            ((TileStaticCrystal)tile).facing = 2;
            change = 3;
          }
          if (l == 1) {
            ((TileStaticCrystal)tile).facing = 5;
            change = 1;
          }
          if (l == 2) {
            ((TileStaticCrystal)tile).facing = 3;
            change = 2;
          }
          if (l == 3) {
            ((TileStaticCrystal)tile).facing = 4;
            change = 0;
          }
    ...
    {
    	TileStaticCrystal tileEntity = (TileStaticCrystal) world.getTileEntity(x, y, z);
