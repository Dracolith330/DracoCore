...
public class TileEntityManaPipe extends TileBaseUniversalManaSource implements IPacketReceiver, ISidedInventory, IConnector
{
    ...
    public TileEntityManaPipe()
    {
    	
    }
    public TileEntityManaPipe(int Capacity, int maxExtract)
    {
    ...
    {
        if (direction == null || type != NetworkType.MANA)
        {
            return false;
        }
