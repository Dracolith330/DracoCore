...
public class RitualAltarRender extends TileEntitySpecialRenderer {
	private RenderHelper.ItemRender resultRenderer;
	float f6 = 0f;	
	public static String element;
	private ModelRitualAltar aModel;
    ...
    public RitualAltarRender() {
        aModel = new ModelRitualAltar();
    ...
    public void renderAModelAt(TileEntityRitualAltar tileentity1, double d, double d1, double d2, float f) 
    {
    	
    		
            this.bindTexture(new ResourceLocation(References.texturelocation, "textures/BlockModels/RitualAltar.png"));
            GL11.glPushMatrix();
            ...
            if (tileentity1 instanceof TileEntityRitualAltar)
            {
            	TileEntityRitualAltar tileAltar = (TileEntityRitualAltar) tileentity1;
    		...
    		this.bindTexture(new ResourceLocation(References.texturelocation, "textures/BlockModels/Bowl.png"));
    		this.Bowl.render((Entity)null, 0, 0, 0, 0, 0.0F, 0.0625F);
            ...
            this.bindTexture(new ResourceLocation(References.texturelocation, "textures/BlockModels/Candle.png"));
            this.Candles.render((Entity)null, f1, f4, f5, f6, 0.0F, 0.0625F);
        ...
        renderAModelAt((TileEntityRitualAltar)tileentity, d, d1, d2, f);
    }
