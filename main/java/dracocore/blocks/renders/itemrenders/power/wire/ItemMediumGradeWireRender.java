...
public class ItemMediumGradeWireRender implements IItemRenderer {

	private static final ResourceLocation ManaPipe = new ResourceLocation(References.texturelocation, "textures/model/MediumGradeWire.png");
    public final IModelCustom Pipe;
    
	public ItemMediumGradeWireRender() {
