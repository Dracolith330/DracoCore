...
public class ElementalCrystal extends BlockTileGC implements ItemBlockDesc.IBlockShiftDesc
{
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLiving, ItemStack itemStack)
    {
    	...
    	if (l == 0) {
            ((TileEntityElementalCrystal)tile).facing = 2;
            change = 3;
          }
          if (l == 1) {
            ((TileEntityElementalCrystal)tile).facing = 5;
            change = 1;
          }
          if (l == 2) {
            ((TileEntityElementalCrystal)tile).facing = 3;
            change = 2;
          }
          if (l == 3) {
            ((TileEntityElementalCrystal)tile).facing = 4;
            change = 0;
          }
    ...
    {
    	TileEntityElementalCrystal tileEntity = (TileEntityElementalCrystal) world.getTileEntity(x, y, z);
    ...
    {
        return new TileEntityElementalCrystal();
    }
