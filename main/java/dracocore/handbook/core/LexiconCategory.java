...
public class LexiconCategory implements Comparable<LexiconCategory> {
    ...
    public final List<LexiconCategory> Categories = new ArrayList<LexiconCategory>();
    private final int sortingId;
    private ResourceLocation icon;
    private int priority = 5;
	private KnowledgeType type = CoreMain.basicKnowledge;
	...
	public LexiconCategory setKnowledgeType(KnowledgeType type) {
		this.type = type;
		return this;
	}
    /**
