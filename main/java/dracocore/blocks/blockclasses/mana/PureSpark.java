...
public class PureSpark extends BlockTransmitter implements ITileEntityProvider, ItemBlockDesc.IBlockShiftDesc
{
    ...
    {
    	return new TilePureSpark();
    }
    @Override
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int idk, float what, float these, float are)
    {
    	TilePureSpark tileEntity = (TilePureSpark) world.getTileEntity(x, y, z);
