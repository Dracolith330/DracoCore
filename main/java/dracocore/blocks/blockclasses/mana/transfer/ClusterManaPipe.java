...
public class ClusterManaPipe extends BlockTransmitter implements ITileEntityProvider, ItemBlockDesc.IBlockShiftDesc
{
	
    public ClusterManaPipe()
    {
    ...
    {
    	return new TileClusteredManaPipe();
    }
    @Override
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int idk, float what, float these, float are)
    {
    	TileClusteredManaPipe tileEntity = (TileClusteredManaPipe) world.getTileEntity(x, y, z);
