package dracocore.blocks.blockclasses.mana.transfer;
...
public class ElementalManaPipe extends BlockTransmitter implements ITileEntityProvider, ItemBlockDesc.IBlockShiftDesc
{
	
    public ElementalManaPipe()
    {
    ...
    {
    	return new TileElementalManaPipe();
    }
    @Override
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int idk, float what, float these, float are)
    {
    	TileElementalManaPipe tileEntity = (TileElementalManaPipe) world.getTileEntity(x, y, z);
