...
public class ClusteredManaPipeRender extends TileEntitySpecialRenderer 
{
    ...
    public ClusteredManaPipeRender() {
    ...
    public void renderModelAt(TileClusteredManaPipe tileEntity, double d, double d1, double d2, float f)
    {
    	FMLClientHandler.instance().getClient().renderEngine.bindTexture(ClusteredManaPipeRender.ManaPipe);
    ...
    {
    	renderModelAt((TileClusteredManaPipe)tileentity, d, d1, d2, f);
    }
 
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) 
    {
		TileEntityRendererDispatcher.instance.renderTileEntityAt(new TileClusteredManaPipe(), 2.0D, 2.0D, 2.0D, 0.0F);
	}
