...
public class ItemHighGradeWireRender implements IItemRenderer {

	private static final ResourceLocation ManaPipe = new ResourceLocation(References.texturelocation, "textures/model/HighGradeWire.png");
    public final IModelCustom Pipe;
    
	public ItemHighGradeWireRender() {
