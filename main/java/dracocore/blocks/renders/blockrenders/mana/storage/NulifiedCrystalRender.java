...
public class NulifiedCrystalRender extends TileEntitySpecialRenderer 
{
    ...
    public void renderAModelAt(TileNulifiedCrystal tileentity1, double d, double d1, double d2, float f) 
    {
    ...
    private void translateFromOrientation(double x, double y, double z, int orientation)
    {
      ...
      case 2: 
        ...
        public void renderTileEntityAt(TileEntity tileentity, double d, double d1, double d2, float f) 
        {
        	...
        	renderAModelAt((TileNulifiedCrystal)tileentity, d, d1, d2, f);
        }
