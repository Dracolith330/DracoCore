...
public class NullManaPipeRender extends TileEntitySpecialRenderer 
{
    private static final ResourceLocation ManaPipe = new ResourceLocation(References.texturelocation, "textures/model/NullifiedManaPipe.png");
    public final IModelCustom Pipe;
    public final IModelCustom Crystal;

    public NullManaPipeRender() {
    ...
    public void renderModelAt(TileNullifiedManaPipe tileEntity, double d, double d1, double d2, float f)
    {
    	FMLClientHandler.instance().getClient().renderEngine.bindTexture(NullManaPipeRender.ManaPipe);
    ...
    {
    	renderModelAt((TileNullifiedManaPipe)tileentity, d, d1, d2, f);
    }
    
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) 
    {
		TileEntityRendererDispatcher.instance.renderTileEntityAt(new TileNullifiedManaPipe(), 0.0D, 0.0D, 0.0D, 0.0F);
	}
