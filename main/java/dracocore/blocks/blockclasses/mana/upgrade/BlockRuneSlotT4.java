...
public class BlockRuneSlotT4 extends BaseRuneSlot
{
    ...
    {
    	TileEntityRunicUpgradeT4 tileEntity = (TileEntityRunicUpgradeT4) world.getTileEntity(x, y, z);
    ...
    {
        return new TileEntityRunicUpgradeT4();
    }
}