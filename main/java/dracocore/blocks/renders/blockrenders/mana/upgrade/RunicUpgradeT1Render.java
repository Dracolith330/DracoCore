...
public class RunicUpgradeT1Render extends TileEntitySpecialRenderer {
    ...
    public void renderAModelAt(TileEntityRunicUpgradeT1 tileentity1, double d, double d1, double d2, float f) {
            ...
            if (tileentity1 instanceof TileEntityRunicUpgradeT1)
            {
            	TileEntityRunicUpgradeT1 tileAltar = (TileEntityRunicUpgradeT1) tileentity1;
        ...
        {
        	renderAModelAt((TileEntityRunicUpgradeT1)tileentity, d, d1, d2, f);
        }
