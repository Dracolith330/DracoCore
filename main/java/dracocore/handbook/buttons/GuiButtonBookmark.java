...
public class GuiButtonBookmark extends GuiButtonLexicon {
    ...
    public void drawButton(Minecraft mc, int par2, int par3) {
        ...
        if (displayString.equals("+"))
            tooltip.add(StatCollector.translateToLocal("dracocoremisc.clickToAdd"));
        else {
            tooltip.add(String.format(StatCollector.translateToLocal("dracocoremisc.bookmark"), id - GuiLexicon.BOOKMARK_START + 1));
            tooltip.add(EnumChatFormatting.GRAY + StatCollector.translateToLocal("dracocoremisc.clickToSee"));
            tooltip.add(EnumChatFormatting.GRAY + StatCollector.translateToLocal("dracocoremisc.shiftToRemove"));
        }
