...
public class PerfectGradeWire extends BlockTransmitter implements ITileEntityProvider, ItemBlockDesc.IBlockShiftDesc
{
	
    public PerfectGradeWire()
    {
    ...
    {
    	return new TileEntityPerfectGradeWire(300, 150);
    }
    @Override
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int idk, float what, float these, float are)
    {
    	TileEntityPerfectGradeWire tileEntity = (TileEntityPerfectGradeWire) world.getTileEntity(x, y, z);
