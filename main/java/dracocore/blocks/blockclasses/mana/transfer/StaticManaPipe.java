...
public class StaticManaPipe extends BlockTransmitter implements ITileEntityProvider, ItemBlockDesc.IBlockShiftDesc
{
	
    public StaticManaPipe()
    {
    ...
    {
    	return new TileStaticManaPipe();
    }
    @Override
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int idk, float what, float these, float are)
    {
    	TileStaticManaPipe tileEntity = (TileStaticManaPipe) world.getTileEntity(x, y, z);
