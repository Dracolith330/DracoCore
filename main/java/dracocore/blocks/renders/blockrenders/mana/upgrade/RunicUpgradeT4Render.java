...
public class RunicUpgradeT4Render extends TileEntitySpecialRenderer {
    ...
    public void renderAModelAt(TileEntityRunicUpgradeT4 tileentity1, double d, double d1, double d2, float f) {
        ...
        if (tileentity1 instanceof TileEntityRunicUpgradeT4)
        {
        	TileEntityRunicUpgradeT4 tileAltar = (TileEntityRunicUpgradeT4) tileentity1;
        ...
        {
        	renderAModelAt((TileEntityRunicUpgradeT4)tileentity, d, d1, d2, f);
        }
