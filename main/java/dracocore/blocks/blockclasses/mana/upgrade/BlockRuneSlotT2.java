...
public class BlockRuneSlotT2 extends BaseRuneSlot
{
    ...
    {
    	TileEntityRunicUpgradeT2 tileEntity = (TileEntityRunicUpgradeT2) world.getTileEntity(x, y, z);
    ...
    {
        return new TileEntityRunicUpgradeT2();
    }
}