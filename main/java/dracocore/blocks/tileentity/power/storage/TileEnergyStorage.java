package dracocore.blocks.tileentity.power.storage;
...
public class TileEnergyStorage extends TileBaseUniversalManaSource implements IPacketReceiver, ISidedInventory, IConnector
{
     ...
     */
    public TileEnergyStorage(float maxCapacity, float maxExtract)
    {
