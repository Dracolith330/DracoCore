...
public class CorruptObelisk extends BlockTransmitter implements ITileEntityProvider, ItemBlockDesc.IBlockShiftDesc
{
    ...
    {
    	return new TileCorruptObelisk();
    }
    @Override
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int idk, float what, float these, float are)
    {
    	TileCorruptObelisk tileEntity = (TileCorruptObelisk) world.getTileEntity(x, y, z);
