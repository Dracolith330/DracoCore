...
public class TilePureSpark extends TileManaStorage
{

	protected TileEntity supertile;
	public int ticksExisted = 0;
	
	public TilePureSpark() 
	{
		super(100000, 100000);
	}
	...
	public void updateEntity()
	{
		if(ticksExisted % 5 == 0) {
			...
			for(EntityLivingBase entity : entities) {
				...
				if(entity instanceof EntityCaveSpider && !this.worldObj.isRemote && this.storage.getEnergyStored() >= 1500) 
				{
					entity.setDead();
				...
				if(entity instanceof EntityMagmaCube && !this.worldObj.isRemote && this.storage.getEnergyStored() >= 1500)
				{
					entity.setDead();
				...
				if(entity instanceof EntityZombie && (((EntityZombie) entity).isVillager()) && !this.worldObj.isRemote && this.storage.getEnergyStored() >= 1500)
				{
					entity.setDead();
					EntityVillager entitymagmacube = new EntityVillager(this.worldObj);
					entitymagmacube.setLocationAndAngles(entity.posX, entity.posY, entity.posZ, entity.rotationYaw, entity.rotationPitch);
					this.getWorldObj().playAuxSFX(1017, (int)entity.posX, (int)entity.posY, (int)entity.posZ, 0);
		            this.worldObj.spawnEntityInWorld(entitymagmacube);
		            this.storage.setEnergyStored(this.storage.getEnergyStored() - 1500);
					break;
				}
