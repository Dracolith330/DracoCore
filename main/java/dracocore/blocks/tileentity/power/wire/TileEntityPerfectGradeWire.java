...
public class TileEntityPerfectGradeWire extends TileBaseUniversalElectricalSource implements IPacketReceiver, ISidedInventory, IConnector
{
    ...
    public TileEntityPerfectGradeWire()
    {
    	
    }
    
    public TileEntityPerfectGradeWire(int Capacity, int maxExtract)
    {
