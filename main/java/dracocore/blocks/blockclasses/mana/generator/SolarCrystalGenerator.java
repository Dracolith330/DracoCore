...
public class SolarCrystalGenerator extends BlockTileGC implements ItemBlockDesc.IBlockShiftDesc
{
    ...
    {
    	TileEntitySolarManaGenerator tileEntity = (TileEntitySolarManaGenerator) world.getTileEntity(x, y, z);
    ...
    {
        return new TileEntitySolarManaGenerator();
    }
	@Override
